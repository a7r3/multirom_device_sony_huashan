...
$(recovery_uncompressed_device_ramdisk): $(MKBOOTFS) \
	...
	$(hide) cp device/sony/huashan/prebuilts/logo.rle $(TARGET_RECOVERY_ROOT_OUT)/
...
$(INSTALLED_BOOTIMAGE_TARGET): $(PRODUCT_OUT)/kernel \
	...
	$(hide) cp device/sony/huashan/prebuilts/logo.rle $(PRODUCT_OUT)/combinedroot/logo.rle
	...
	$(hide) python $(MKELF) -o $@ $(PRODUCT_OUT)/kernel@0x80208000 $(PRODUCT_OUT)/combinedroot.fs@0x81900000,ramdisk device/sony/huashan/prebuilts/RPM.bin@0x00020000,rpm device/sony/huashan/rootdir/cmdline.txt@cmdline
